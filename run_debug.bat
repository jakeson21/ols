...
java %PLATFORMOPTS% %MEMSETTINGS% %SYSPROPS% -Xdebug -Xrunjdwp:transport=dt_socket,address=5005,server=y -cp "%CLASSPATH%" nl.lxtreme.ols.runner.Runner -pluginDir="%PLUGINDIR%" %*
